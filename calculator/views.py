...
class ProgramsCalculator(ListView):
    ...
    def get_queryset(self):
        ...
        if self.request.GET['sort_by'] == 'salary':
            ...
            suitable_programs = [program for program in sorted(suitable_programs, key=lambda x: -x.average_score)]
        suitable_programs = [program for program in suitable_programs if program.is_suitable(self.request.GET)]
